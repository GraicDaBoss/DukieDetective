...
public class Emelda : MonoBehaviour
{
    public UnityEvent enteredTrigger, exitedTrigger;
    private bool isInsideTrigger;
    public GameObject TalkPanel, PlayerCapsule, Camera;
    public TMP_Text TalkText;
    private string[] dialogues = { "", "You're looking for a murderer?", "I saw someone come through here with a knife.", "But he just used it to chop onions. Weird...", "On his way back he hid something in those bushes.", "That's all I have for you."};
